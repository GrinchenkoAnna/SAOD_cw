...
void display_queue() //print the queue (all records)
{
    ...
    while(p)
    {
        cout << setw(30) << p -> inf -> full_name_depositor;
        cout << setw(10) << p -> inf -> deposit_sum;
        cout << setw(10) << p -> inf -> deposit_date;
        cout << setw(23) << p -> inf -> full_name_advocate << endl;
